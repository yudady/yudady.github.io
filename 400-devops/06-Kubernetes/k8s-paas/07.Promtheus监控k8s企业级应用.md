...
"annotations":{
  "blackbox_path": "/k8s02?name=health",
  "blackbox_port": "8080",
...
浏览器输入[demo-test.od.com/k8s02?name=tomcat](demo-test.od.com/hello?name=tomcat)
...
~~~
# 浏览器输入：demo-test.com/k8s02?name=tomcat
~~~
...
~~~
# 访问浏览器demo-prod.od.com/k8s02?name=prod
~~~
